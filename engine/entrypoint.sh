...
LOG_FILE="/var/lib/watchx/recordings/logs/engine.log"
...
trap "log 'Terminating WatchX Engine...'; kill -TERM $MAIN_PID 2>/dev/null; rm -f $FIFO" INT TERM
