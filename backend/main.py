...
logger = logging.getLogger("WatchXBackend")
...
async def lifespan(app: FastAPI):
    ...
    default_keys = [
        "watchx-super-secret-key-change-me",
        "watchx_secure_key_9823748923748923_change_in_prod",
    ...
    with database.get_db_ctx() as db:
        try:
            ...
            # Initialize default settings if new settings were added
...
if "*" in allowed_origins:
    ...
    logger.warning("!! For production, set this to your specific domain (e.g., https://watchx.io). !!")
    logger.warning("--------------------------------------------------------------------------------")
...
@app.get("/")
def read_root():
    return {"message": "Welcome to WatchX API"}
