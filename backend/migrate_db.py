...
logger = logging.getLogger("WatchXMigrate")
...
def migrate():
    ...
    # Videos
    add_column_if_not_exists(engine, "cameras", "video_file_name", "VARCHAR", "%Y-%m-%d/%H-%M-%S")
    add_column_if_not_exists(engine, "cameras", "video_passthrough", "BOOLEAN", False)
    add_column_if_not_exists(engine, "cameras", "video_quality", "INTEGER", 75)
    ...
    add_column_if_not_exists(engine, "cameras", "max_video_length", "INTEGER", 0)
    add_column_if_not_exists(engine, "cameras", "record_audio", "BOOLEAN", False)
    add_column_if_not_exists(engine, "cameras", "preserve_videos", "VARCHAR", "For One Week")
