...
def generate_debug_report():
    ...
    report = []
    report.append("=== WatchX System Report ===")
    ...
    with database.get_db_ctx() as db:
        try:
            ...
            for cam in cameras:
                ...
                report.append(f"    Video Passthrough: {cam.video_passthrough}")
...
async def download_all_logs(user: dict = Depends(get_current_user)):
    ...
    headers = {
        'Content-Disposition': 'attachment; filename="watchx_logs_sanitized.zip"'
    }
