...
export const CATEGORY_FIELD_MAP = {
    recording: ['recording_mode', 'video_quality', 'video_passthrough', 'max_video_length', 'preserve_videos', 'max_storage_gb', 'live_view_mode', 'rtsp_transport', 'sub_rtsp_transport'],
    ...
    alerts: [
        'notify_telegram_token', 'notify_telegram_chat_id', 'notify_email_address',
        'notify_health_telegram_token', 'notify_health_telegram_chat_id',
        'notify_health_email_recipient', 'notify_start_email', 'notify_start_telegram',
        'notify_start_command', 'notify_end_command', 'notify_health_email',
        'notify_health_telegram', 'notify_attach_image_email', 'notify_attach_image_telegram'
    ],
    schedule: [
...
export const EXCLUDED_FIELDS = [
    ...
    'is_active', 'groups', 'resolution_width', 'resolution_height', 'auto_resolution',
    'rtsp_username', 'rtsp_password', 'rtsp_host', '_sa_instance_state', 'previous_recording_mode', 'client_user_ids'
];
