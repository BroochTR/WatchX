...
import { Video, Image as ImageIcon, Download, Trash2, Camera, Brain } from 'lucide-react';
            ...
            <div className="flex-1 p-2 flex flex-col justify-between min-w-0">
                ...
                <div className="flex justify-between items-center">
                    <div className="flex flex-col">
                        <span className="text-[10px] text-muted-foreground/90">{time}</span>
                        <span className="text-[8px] text-muted-foreground/75">{date}</span>
                    </div>
