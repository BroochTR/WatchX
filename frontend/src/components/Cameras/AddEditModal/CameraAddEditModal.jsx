...
export const CameraAddEditModal = ({
    ...
    // Redirect away from AI tab if the selected engine is not AI.
    useEffect(() => {
                        ...
                        <div className="mb-6 p-4 bg-primary/5 border border-primary/20 rounded-xl animate-in fade-in slide-in-from-top-2 duration-300 shadow-sm">
                            ...
                            {cloneSourceId && (
                                <div className="mt-4 animate-in fade-in zoom-in-95 duration-200">
                                    ...
                                    <p className="text-[10px] text-muted-foreground mt-2 italic">* Unique settings such as URLs are never cloned.</p>
                                </div>
                            )}
                        </div>
                    )}
