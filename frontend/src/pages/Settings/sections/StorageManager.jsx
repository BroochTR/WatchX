...
export const StorageManager = ({
    ...
    return (
        <CollapsibleSection
            ...
            description="Configure global quotas and cleanup policies."
                        ...
                        <table className="w-full text-sm text-left border-collapse">
                            <thead>
                                <tr className="border-b border-border text-xs text-muted-foreground uppercase tracking-wider">
                                    ...
                                    <th className="py-2 px-1 font-semibold text-right">Videos</th>
                                        ...
                                        <tr key={cam.id} className="border-b border-border/50 hover:bg-muted/30 transition-colors">
                                            ...
                                            <td className="py-3 px-1 text-right">
                                                <div className="flex flex-col items-end">
                                                    <span>{camStats.videos.size_gb} GB</span>
                                                    <span className="text-[10px] text-muted-foreground">{camStats.videos.count} files</span>
                                                </div>
                                            </td>
                                            <td className="py-3 px-1 text-right">
                                                <div className="flex flex-col items-end">
                                                ...
                                                <div className="flex justify-end gap-1">
                                                    <button
                                                        ...
                                                        onClick={() => {
                                                            setConfirmConfig({
                                                                isOpen: true,
                                                                title: 'Cleanup Videos: ' + cam.name,
                                                                message: 'Delete videos for this camera that exceed its specific retention or quota?',
                                                                onConfirm: async () => {
                                                                    try {
