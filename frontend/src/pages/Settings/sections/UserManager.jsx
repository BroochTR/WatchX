                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <span className={`inline-flex items-center px-2 py-0.5 rounded-lg text-xs font-bold uppercase tracking-wider ${u.role === 'admin' ? 'bg-primary/10 text-primary border border-primary/20' : u.role === 'client' ? 'bg-amber-500/10 text-amber-600 border border-amber-500/20' : 'bg-muted text-muted-foreground border border-border/50'}`}>
                                        {u.role}
                                    </span>
                                </div>
                            </div>
                                ...
                                <tr key={u.id} className="border-t border-border hover:bg-muted/10">
                                    ...
                                    <td className="p-3">
                                        <span className={'inline-flex items-center px-2 py-0.5 rounded text-xs font-bold uppercase tracking-wider ' +
                                            (u.role === 'admin' ? 'bg-primary/10 text-primary border border-primary/20' : u.role === 'client' ? 'bg-amber-500/10 text-amber-600 border border-amber-500/20' : 'bg-muted text-muted-foreground border border-border/50')
                                        }>
                                            {u.role}
                                        </span>
                                    </td>
