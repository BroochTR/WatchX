...
export const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const deviceToken = localStorage.getItem('watchx_device_token');
            if (deviceToken) {
            ...
            if (res.ok) {
                ...
                if (data.device_token) {
                    ...
                    localStorage.setItem('watchx_device_token', data.device_token);
                } else {
                ...
                <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-500 text-sm sm:text-base mt-1">
                            {require2FA ? 'Enter your 2FA code' : 'Enter your credentials to access WatchX'}
                        </p>
                    </div>
                </div>
