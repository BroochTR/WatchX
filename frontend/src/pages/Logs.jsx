...
export const Logs = () => {
    ...
    const handleDownload = () => {
        setConfirmConfig({
            ...
            message: 'You are about to download a system report and logs archive. This includes WatchX system information, resource usage, configuration summaries, and sanitized application logs. Sensitive data (tokens, passwords, IPs) is redacted.',
            onConfirm: async () => {
                try {
                    ...
                    if (res.ok) {
                        ...
                        a.href = url;
                        a.download = `watchx_logs_${new Date().toISOString().slice(0, 10)}.zip`;
    ...
    return (
        <div className="flex h-full min-h-[32rem] flex-col space-y-4 p-4 sm:p-5 lg:p-6">
